...
Each data line provide the corresponding information to the fields included in the header line for a position of the genome. There are many annotations associated with each variant and they are listed in the **INFO** column.
